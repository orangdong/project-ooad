        ...
        <div class="content-4-1 d-flex flex-column align-items-center h-100 flex-lg-row no-select auth-background"
            ...
            <div class="d-flex mx-auto align-items-left justify-content-left width-right mx-lg-0">
                <div class="right mx-lg-0 mx-auto">
                    ...
                    <h3 class="title-text">Register your Account</h3>
                    <p class="caption-text">
                        Daftarkan akunmu sekarang dan<br />
                        akses website NTT Market.
                    </p>
                    <form style="margin-top: 1.5rem" action="{{ route('register') }}" method="post">
                            ...
                            <div class="d-flex justify-content-between">
                                <div class="me-3">
                                    ...
                                    <div class="d-flex w-100 div-input">
                                        ...
                                        <input class="input-field border-0" type="text" name="name"
                                ...
                                <div>
                                    ...
                                    <div class="d-flex w-100 div-input">
                                        ...
                                        <input class="input-field border-0" type="text" name="username"
                        ...
                        <div style="margin-top: 1rem">
                            <div class="d-flex justify-content-between">
                                <div class="me-3">
                                    ...
                                    <div class="d-flex w-100 div-input">
                                        <div style="margin-right: 1rem;">
                                            <i width="24" height="24" style="color: #CACBCE;" class="fas fa-envelope icon"></i>
                                        </div>
                                        <input class="input-field border-0" type="email" name="email"
                                ...
                                <div>
                                    ...
                                    <div class="d-flex w-100 div-input">
                                        <div style="margin-right: 1rem;">
                                            <i width="24" height="24" style="color: #CACBCE;" class="fas fa-phone-alt icon"></i>
                                        </div>
                                        <input class="input-field border-0" type="number" name="number"
                            ...
                            <div class="d-flex justify-content-between">
                                ...
                                <div>
                                    ...
                                    <div class="d-flex w-100 div-input">
                                        ...
                                        <input class="input-field border-0" type="password" name="password_confirmation" id="password-content-4-1"
                        ...
                        <div style="margin-top: 1rem">    
                            ...
                            <div class="d-flex w-100 div-input">
                                ...
                                <input class="input-field border-0" type="date" name="date_of_birth"
                                    placeholder="Your birthday" autocomplete="off" required />
                            </div>
                        </div>
                        <div style="margin-top: 1rem">
                            ...
                            <div class="d-flex w-100 div-input">
                                <div style="margin-right: 1rem;">
                                    <i width="24" height="24" style="color: #CACBCE;" class="fas fa-map-marker-alt icon"></i>
                                </div>
                                <input class="input-field border-0" type="text" name="address"
                        ...
                        <div style="margin-top: 1rem">
                            ...
                            <div class="d-flex w-100 mt-2">
                                  <div class="form-check me-3">
                                    <input style="padding: 10px; margin-right: 8px;" class="form-check-input" value="user" type="radio" name="role" id="user">
                                    <label style="font-size: 19px" class="form-check-label" for="user">
                                      Turis
                                    </label>
                                  </div>
                                  <div class="form-check">
                                    <input style="padding: 10px; margin-right: 8px;" class="form-check-input" value="seller" type="radio" name="role" id="seller">
                                    <label style="font-size: 19px" class="form-check-label" for="seller">
                                      UMKM
                                    </label>
                                  </div>
                            </div>
                    ...
                    <p class="text-center bottom-caption no-select">
                        Sudah punya akun?
                        <a class="green-bottom-caption" href="{{route('login')}}">Masuk di sini</a>
                    </p>
                </div>
            </div>
        </div>
